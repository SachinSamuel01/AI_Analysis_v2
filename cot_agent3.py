...
def check_if_new_pilot(name: str) -> bool:
    ...
    return False if 'C' == name[-4] else True


def check_pilot_gender(name:str)->bool:
    "check pilot gender based on its name returns True for female and False for male"
    return False if "V" in name else True
...
class ChainOfThoughtAgent:
    ...
    def initialize_agents(self):
        ...
        namespace = {
            ...
            "gender_checker": check_pilot_gender
        }
        ...
        tools = [
            Tool(
                ...
                - pilot_checker: Check if pilot is new based on name returns True if pilot is else else False
                - gender_checker: check pilot gender based on its name returns True for female and False for male
                """
            )
        ]
        ...
        self.analysis_agent = create_pandas_dataframe_agent(
            ...
            prefix= """You have access to a pandas dataframe and a tool called 'pilot_checker'.
                     ...
                     Note: never define tool functions Always use the tools provided""",
...
if __name__ == "__main__":
    ...
    query= '''Tell me how many female  pilots are there in the data'''
    query= '''Tell me how many male pilots are new in the given data'''
